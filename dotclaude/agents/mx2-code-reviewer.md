...
These checks encode human reviewer standards from the team's [Code Review Guide](<internal-confluence-url>). They apply in all modes because they require understanding intent, not pattern matching.
